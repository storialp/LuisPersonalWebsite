    ...
    >
      ...
      >
        ...
        <div className="px-6 py-6 space-y-8">
          <section>
            <h3 className="text-[10px] font-semibold text-white/30 uppercase tracking-[0.15em] mb-4">Contact Info</h3>
            <div className="space-y-6">
              {contactLinks.map((link) => (
                <div key={link.label} className="flex gap-4">
                  <div className={`mt-1 flex-shrink-0 ${link.color}`}>
                    {link.icon}
                  </div>
          ...
          <section>
             <h3 className="text-[10px] font-semibold text-white/30 uppercase tracking-[0.15em] mb-4">Current Base</h3>
